...
object adt {
  ...
  object case_classes {
    ...
    case class CreditCard(number: String, expirationDate: java.time.YearMonth, name: String, securityCode: Short)
  }
  ...
  object either {
    ...
    val v41: IntOrString = Left(1)
    val v51: IntOrString = Right("first")
